...
- [x] **Bug bloquant** : dans Workout, ajouter un exercice à sa séance renvoyait sur l'onglet Musculation/Course au lieu de rester sur la séance en cours (`WorkoutLibrary.jsx` naviguait vers `/workout` au lieu de `/workout/session`). **Corrigé** le jour même.
...
- [ ] **Question stratégique posée par l'utilisateur : fusionner coach + IA dans une seule app premium, potentiellement en SaaS multi-salles** — voir section "Orientation produit" ci-dessous pour la réponse complète de Claude.
